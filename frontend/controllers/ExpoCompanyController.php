                      ...
                      //  $transaction = $this->getDb()->beginTransaction();
                        foreach ($ExpoMktDocModel->doc_name as $file) {
                          $ExpoMktDocModel = new ExpoMktDoc();
                            ...
                            $ExpoMktDocModel ->doc_path = '../web/assets/uploads/';
           ...
           // $expoStand->stand_owner_id = $model->id;
            ...
            //$expoStand->update();
               ...
               // $model->mkt_doc_dir ='../web/assets/uploads/';
                $model->file='web/assets/uploads/'. $file1->baseName.'-'.$imageName . '.' . $file1->extension;    
                $model->mkt_doc_dir = 'web/assets/uploads/'. $imageName . '.' . $file1->extension; 
