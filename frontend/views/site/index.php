<?php require_once('I:\wamp64\www\advanced\common\config\Mysql.php');
 ...
 $scope.BookYourPlace = function(event, e) {
  if ($(".btn-link").hasClass("logout")){
    ...
    console.log("username -"+username);
      window.location ='../web/index.php?r=site/stand&eventID='+eventID2+"&username="+username;
  }else{

      window.location ='../web/index.php?r=site%2Fsignup';
...
<script language="javascript" type="text/javascript">
 function showEventDetails(eventID){
      ...
      var check="../views/site/map_cl_service.php?eventid="+eventID+"&action=listpoints";
     ...
     console.log("This is addLocation2");
				  ...
				  var avg = {
					...
					var myOptions = {
                       ...
                       var check="../views/site/map_service.php?action=listpoints";
                        console.log(check);
                    	$.getJSON(check, function(json) {
